...
var CheckboxGroup = /** @class */ (function (_super) {
    ...
    CheckboxGroup.prototype.render = function () {
        ...
        var inputs = this.props.options.map(function (opt) { return (React.createElement("div", { className: 'form-check', key: opt.value },
            React.createElement("input", { type: 'checkbox', className: 'form-check-input', name: _this.props.setName, onChange: _this.props.controlFunc, value: opt.value, checked: _this.props.selectedOptions.indexOf(opt.value) > -1, id: _this.props.setName + '-' + opt.value }),
